...
report_assets/images/<file> — used by the in-browser screenshot capture to persist
...
ASSET_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "report_assets", "images")
