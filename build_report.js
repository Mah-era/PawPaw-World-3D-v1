...
const IMG_DIR = path.join(__dirname, "report_assets", "images");
const cache = {};
function img(name) {
...
fs.writeFileSync(path.join(__dirname, "PAWPAW_WORLD_Report.html"), html);
const kb = (Buffer.byteLength(html) / 1024 / 1024).toFixed(2);
console.log("wrote PAWPAW_WORLD_Report.html (" + kb + " MB, " + GALLERY.length + " gallery shots)");
